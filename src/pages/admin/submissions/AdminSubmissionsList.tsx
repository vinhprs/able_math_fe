...
export function AdminSubmissionsList() {
  ...
  const filteredSubmissions =
    submissions?.filter(
      (sub) =>
        ...
        sub.teacher.name.toLowerCase().includes(search.toLowerCase()) ||
  ...
  const handleViewReport = (submission: Submission) => {
    if (submission.test.testType === "ADTM") {
      ...
      // Use ResultReview for Achievement tests (accessible by admin)
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Monitor and review all test submissions across the platform
        </p>
      </div>
